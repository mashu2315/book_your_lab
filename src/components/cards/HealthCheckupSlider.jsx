...
//         oldPrice: "₹ 3000/-",
//         newPrice: "₹ 1300/-",
//         image: cardimage, // Replace with actual image
//     },
//     {
//         id: 2,
//         title: "Full Body Health Checkup",
...
//            <div className="relative px-4 sm:px-6 md:px-10 w-full max-w-[1000px] mx-auto h-auto sm:h-[300px] my-10 overflow-visible">
//         {/* className={`px-3 mt-[50px]  transition-all duration-500 ease-in-out`} */}

//             <Slider {...settings}>
//                 {checkups.map((item) => (
//                     <div key={item.id} className={`px-3 relative ${
//                                 item.id === 1
//                                     ? 'scale-110 bg-blur-sm opacity-20'
//                                     : 'scale-100'
//                             } overflow-hidden`} >
...
//                                     </p>
//                                     <div className="my-2">
//                                         <p className="text-sm font-semibold text-white relative flex  justify-center">
//                                             {item.oldPrice}
//                                             <span className="absolute left-100 top-1/2 w-[50px] h-[2px] bg-red-500 "></span>
//                                         </p>
//                                         <p className="text-xl font-bold text-white">{item.newPrice}</p>
//                                     </div>
//                                 </div>

//                             </div>
//                             <div className="absolute top-4 -left-[29px]  w-[120px] text-center -rotate-[45deg] text-white bg-[#097C9A] py-[0.125px]"> 60% Off </div>
//                             </div>
//                             <button className="bg-[#097C9A] text-white text-sm font-medium w-full py-2 flex items-center justify-center gap-2">
