        ...
        <div className='border-[3px] border-[#097C9A]  max-w-[400px] h-[450px] rounded-xl font-poppins overflow-y-clip mx-auto'>
            ...
            <div className='flex flex-col md:flex-row text-[#6F8A9299] p-2 justify-between'>
                <div className=' md:w-1/2 p-2'>
                    <select name="gender" id="gender" className="bg-gray-50 border shadow-md hover:scale-105 transition-all duration-200 hover:border-teal-300 border-gray-300 text-[#6F8A9299] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        <option value="male">Male</option>
                        <option value="female">Female</option>
                    </select>
                </div>
                <div className=' md:w-1/2 p-2'>
                    <select name="age" id="age" className="bg-gray-50 border shadow-md border-gray-300 text-[#6F8A9299] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 hover:scale-105 transition-all duration-200 hover:border-teal-300">
