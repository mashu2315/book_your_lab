...
// const AboutUs = () => {
//     return (
//         <div className='relative mt-[1060px]'>
//             <div className='flex justify-center items-center '>

//                  {/* left div */}
//                 <div className='flex   w-[500px] h-[500px] justify-center'>
//                     <div className='flex  flex-col mr-8 my-8'>
//                         {
//                             About.filter(value => value.id <= 2).map((value) => {
//                                 return (
//                                     <div key={value.id} className='p-2 mb-8 flex flex-col  items-center shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-lg'>
//                                         <img src={value.image} alt="Not Found" className='h-[100px]' />
//                                         <h1 className='font-bold my-2 text-[#434343] text-sm'>{value.title}</h1>
//                                         <p className='text-[#7B7B7B]   mb-3 text-xs'>{value.description}</p>
//                                     </div>
//                                 )
//                             })
//                         }
...
//                 </div>
//                 {/* right div */}
//                 <div className='flex justify-center h-[400px]  flex-col w-[480px]'>
//                     <div className='flex  flex-col h-[700px]items-start justify-center'>
//                         <p className='font-semibold'>Why Choose Us</p>
//                         <div className='bg-[#00DBA1] h-[2px] w-10'></div>
//                         <p className='font-bold text-lg text-[#097C9A] tracking-[4%] mt-1'>We'll Ensure You Always <br /> Get The Best Results</p>

//                     </div>
//                     <div className='text-[#434343] mt-6'>
//                         <p>Your full-service lab for clinical trials. Our mission is to ensure the generation of accurate.
//                             Novalab is registered with the following governmental agencies:

//                         </p>
//                         <ul className='max-w-md text-[15px] list-disc list-inside marker:text-green-500 mt-5'>
//                             <li>    Drug Enforcement Agency (DEA) No. RG0105216
//                             </li>
//                             <li>    Food and Drug Administration (FDA) No. 2182801
//                             </li>
//                             <li>    International Standards Organization (ISO9001 and ISO17025)
//                             </li>
//                             <li>    United States Department of Agriculture (USDA) No. 35-R-034</li>

//                         </ul>
//                         <button className="flex gap-2 mt-8 bg-[#00DBA1] text-white border-0 rounded-br-xl rounded-tl-xl px-4 py-[6px] text-[12px] font-bold ">
//                             View List
//                         </button>
//                     </div>
//                 </div>
      ...
      <div className='flex  flex-col lg:flex-row justify-center items-center gap-8'>
        ...
        <div className='flex lg:flex-row md:w-[500px] md:h-[500px] justify-center flex-col sm:flex-row md:flex-row items-center gap-6'>
          <div className='flex flex-col gap-6 sm:w-1/2 w-full'>
            {
              About.filter(value => value.id <= 2).map((value) => (
                <div key={value.id} className='p-2 flex flex-col items-center shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-lg'>
        ...
        <div className='flex justify-center flex-col w-full lg:mt-14 md:w-[480px]'>
          ...
          <div className='text-[#434343] mt-4 text-sm sm:text-base'>
            ...
            <button className="flex gap-2 mt-6 bg-[#00DBA1] text-white border-0 rounded-br-xl rounded-tl-xl px-4 py-1.5 text-xs font-bold">
              View List
            </button>
          </div>
        </div>
