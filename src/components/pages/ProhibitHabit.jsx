...
const ProhibitHabit = () => {
  ...
  className=" flex flex-col items-center bg-cover border-[4px] bg-center bg-no-repeat lg:h-[600px] w-full"
>
  <div className="custom-headline mt-[80px] scale-95 ">
  ...
  <div>
    <div className='flex pl-5 pt-12 flex-wrap gap-4 '>
    {
        HabitData.map((event)=>{
            return (
                <div key={event.id} className='flex h-[160px] w-[185px] rounded-br-lg rounded-tl-lg items-center justify-center bg-white  flex-col '>
  ...
  <button className=" bg-[#00DBA1] my-6 text-white border-0 rounded-br-xl rounded-tl-xl px-6 py-[6px] text-[12px] font-bold">
                        View Details
    </button>
</div>
